...
class A2C(object):
    ...
    def learn(self):
        ...
        td_error = r_batch + self.conf.discount * v_value_next-v_value
...
if __name__ == '__main__':
    ...
    def return_test():
        ...
        for i in range(conf.test_times):
            ...
            test_step = 0
            while not test_done:
                test_action = a2c_dis.choose_action(torch.tensor(test_obs))
    ...
    for step in range(conf.step):
        ...
        a2c_dis.store_transition(obs, action, reward, obs_next)
